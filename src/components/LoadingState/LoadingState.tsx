  ...
  return (
    <div className={styles.container} role="status">
      <svg className={styles.spinner} viewBox="0 0 56 56" aria-hidden="true" focusable="false">
        <circle className={styles.baseRing} cx="28" cy="28" r="22" fill="none" strokeWidth="6" />
        <circle className={styles.arc} cx="28" cy="28" r="22" fill="none" strokeWidth="6" strokeLinecap="round" strokeDasharray={ARC_DASHARRAY} />
      </svg>
