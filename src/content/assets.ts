...
const assets = [
  {
    ...
    attributionText: 'Moon texture: NASA Goddard / Ernie Wright, CGI Moon Kit (SVS 4720).',
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: "Artist's depiction of a collision between two planetary bodies. NASA / JPL-Caltech.",
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: 'Total solar eclipse, Aug 21, 2017. NASA / Carla Thomas (AFRC2017-0233-005).',
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: 'Full disc of the Moon, Apollo 17, December 19, 1972. NASA (AS17-152-23311).',
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: 'Aristarchus crater, Lunar Reconnaissance Orbiter. NASA / GSFC / Arizona State University.',
  ...
  },
  {
    ...
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Mare_Orientale_(LRO).png',
    originalImageUrl: 'https://upload.wikimedia.org/wikipedia/commons/3/32/Mare_Orientale_%28LRO%29.png',
    author: 'NASA / Lunar Reconnaissance Orbiter',
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: 'Mare Orientale, Lunar Reconnaissance Orbiter mosaic. NASA.',
  ...
  },
  {
    ...
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Mare_Orientale_(GLD100).jpg',
    originalImageUrl: 'https://upload.wikimedia.org/wikipedia/commons/a/a4/Mare_Orientale_%28GLD100%29.jpg',
    author: 'NASA / Lunar Reconnaissance Orbiter',
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: 'Mare Orientale GLD100 topographic map, derived from Lunar Reconnaissance Orbiter data. NASA.',
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: 'Hertzsprung basin, Lunar Reconnaissance Orbiter WAC mosaic. NASA.',
  ...
  },
  {
    ...
    originalImageUrl: 'https://upload.wikimedia.org/wikipedia/commons/1/13/Hertzsprung_%28GLD100%29.jpg',
    author: 'NASA / Lunar Reconnaissance Orbiter',
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: 'Hertzsprung GLD100 topographic map, derived from Lunar Reconnaissance Orbiter data. NASA.',
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: 'Bootprint in the lunar soil, Apollo 11, 20 July 1969. NASA / Buzz Aldrin (AS11-40-5878).',
  ...
  },
  {
    ...
    attributionText: 'Apollo 8 liftoff from Kennedy Space Center, December 21, 1968. NASA (S69-15558).',
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: 'Earthrise, Apollo 8, Dec 24, 1968. NASA / William Anders (AS08-14-2383).',
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: 'Erlanger crater at local sunrise, LROC NAC. NASA / GSFC / Arizona State University.',
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: 'Mare Tranquillitatis pit, LROC NAC. NASA / GSFC / Arizona State University.',
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: 'David Scott in the Command and Service Module hatch, March 1969. NASA (AS09-20-3064).',
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: 'The Command and Service Module photographed from the Lunar Module in lunar orbit, May 1969. NASA (AS10-27-3873).',
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: 'Buzz Aldrin on the Moon, July 20, 1969. NASA / Neil Armstrong (AS11-40-5903).',
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: 'Alan Bean holding a lunar soil sample container, November 1969. NASA / Charles Conrad (AS12-49-7278).',
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: "The Lunar Module 'Antares' on the lunar surface, February 1971. NASA (AS14-66-9306).",
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: 'James Irwin and the lunar rover at Hadley Rille, August 1971. NASA (AS15-86-11603).',
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: "John Young's jumping salute, April 1972. NASA / Charles Duke (AS16-113-18339).",
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: 'Harrison Schmitt standing next to a split lunar boulder, December 1972. NASA (AS17-140-21497).',
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: 'Apollo 15 sample 15415, the Genesis Rock, an anorthosite from Spur Crater. NASA (S71-42951).',
  ...
  },
  {
    ...
    source: "JPL news release: Ice confirmed at the Moon's poles (Moon Mineralogy Mapper, M3)",
    sourceUrl: 'https://www.jpl.nasa.gov/news/ice-confirmed-at-the-moons-poles/',
    originalImageUrl: 'https://upload.wikimedia.org/wikipedia/commons/9/9d/The_image_shows_the_distribution_of_surface_ice_at_the_Moon%27s_south_pole_%28left%29_and_north_pole_%28right%29.webp',
    author: 'NASA / Moon Mineralogy Mapper (M3) / Li et al. 2018',
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: "Surface water ice at the Moon's south pole, Moon Mineralogy Mapper (M3). NASA / JPL-Caltech, Li et al. 2018.",
  ...
  },
  {
    ...
    license: 'PD-USGov-NASA',
    licenseUrl: 'https://www.nasa.gov/nasa-brand-center/images-and-media/',
    attributionText: "Surface water ice at the Moon's north pole, Moon Mineralogy Mapper (M3). NASA / JPL-Caltech, Li et al. 2018.",
