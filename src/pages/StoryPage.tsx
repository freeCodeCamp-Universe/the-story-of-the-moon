...
export default function StoryPage() {
  ...
  const moonDiscPostcard = postcards.find(
    (postcard) => postcard.id === 'moon-disc'
  );
  const eclipsePostcard = postcards.find(
    (postcard) => postcard.id === 'eclipse'
  );
  const bootprintPostcard = postcards.find(
    (postcard) => postcard.id === 'bootprint'
  );
