...
export default function Ch5() {
  return (
    <>
      <p className={styles.intro}>Apollo astronauts brought home 382 kilograms of lunar material between 1969 and 1972, across six crewed landings.</p>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.paragraph}>Two families of igneous rock dominate the collection: dark basalts that built the lunar maria, and bright anorthosites that formed the rugged highlands.</p>
      </section>
