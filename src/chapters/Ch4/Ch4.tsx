        ...
        <figure className={styles.panelPhoto}>
          <div className={styles.photoFrame}>
            <OptimizedImage
              ...
              className={PHOTO_POSITION_CLASS[mission.key]}
              loading="lazy"
            />
          </div>
          {credit && (
  ...
  return (
    ...
    >
      ...
      <div ref={stageRef} className={styles.stage}>
        ...
        <div
          data-deck
          className={`${styles.deck} ${reducedMotion ? styles.deckInstant : ''}`}
        >
          {steps.map((step, i) => {
            const isActive = i === active;
  ...
  return (
    <>
      <Prose className={styles.intro}>
        <p>
          For thousands of years, reaching the Moon lived only in the human
          imagination. As early as the second century, the satirist Lucian of
          Samosata wrote of sailing ships lifted into the sky by a whirlwind, a
          whimsical dream that 17th-century astronomy began translating into
          mathematics and 19th-century science fiction kept alive.
        </p>
        <p>
          By the mid-20th century, this dream finally shifted from fantasy to
          physics. To conquer a journey so vast, exploration had to become a
          step-by-step blueprint. This methodical strategy defined NASA's Apollo
          program, and it remains the approach driving the modern Artemis
          missions today.
        </p>
      </Prose>
